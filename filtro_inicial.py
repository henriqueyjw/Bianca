...
# ini_path = '/mnt/e/bianca/possessorio/dados/tjba'
# name_report = 'tjba.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/tjdf'
# name_report = 'tjdf.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/tjpa'
# name_report = 'tjpa.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/tjpe'
# name_report = 'tjpe.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/tjrs'
# name_report = 'tjrs.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/tjsp'
# name_report = 'tjsp.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/trf4'
# name_report = 'extração_trf4.csv'
# ini_path = '/mnt/e/bianca/possessorio/dados/trf4'
# name_report = 'extração_trf5.csv'
ini_path = '/mnt/e/bianca/possessorio/dados/trf1_atual'
name_report = 'extração_trf1.csv'

final_path = '/mnt/e/bianca/possessorio/dados/trf1_versao_2'
...
rows = []
for f in os.listdir(ini_path):
    if f[-3:] == 'csv':
        df = pd.read_csv(os.path.join(ini_path, f), error_bad_lines=False)
        for _, row in df.iterrows():
            ...
            if flag:
                ...
                numero_atual = re.search('\d{1,7}\-\d{2}\.\d{4}\.\d\.\d{2}\.\d{4}|\d{1,7}\-\d{2}\.\d{4}\.\d{3}\.\d{4}|\d{19}', row['texto_publicacao'])
                numero_antigo = re.search('\d{4}\.\d{2}\.\d{1,2}\.\d{6}\-\d{1}|\d{14,15}', row['texto_publicacao'])
                if numero_atual:
                    dici['numero_regex'] = numero_atual.group(0)
                elif numero_antigo:
                    dici['numero_regex'] = numero_antigo.group(0)
                else:
                    dici['numero_regex'] = 0
